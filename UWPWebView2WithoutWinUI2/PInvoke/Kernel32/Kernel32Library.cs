...
namespace UWPWebView2WithoutWinUI2.PInvoke.Kernel32
{
    /// <summary>
    /// Kernel32.dll 函数库
    /// </summary>
    public static partial class Kernel32Library
    {
        ...
        [LibraryImport(Kernel32, EntryPoint = "GetModuleHandleW", SetLastError = false, StringMarshalling = StringMarshalling.Utf16)]
        public static partial IntPtr GetModuleHandle([MarshalAs(UnmanagedType.LPWStr)] string modName);
        ...
        [LibraryImport("kernel32", EntryPoint = "QueryPerformanceFrequency", SetLastError = false)]
