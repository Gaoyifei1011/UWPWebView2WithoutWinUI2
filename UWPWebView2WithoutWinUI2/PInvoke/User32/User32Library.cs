...
namespace UWPWebView2WithoutWinUI2.PInvoke.User32
{
    /// <summary>
    /// User32.dll 函数库
    /// </summary>
    public static partial class User32Library
    {
        ...
        [LibraryImport(User32, EntryPoint = "ClientToScreen", SetLastError = false)]
        ...
        [LibraryImport(User32, EntryPoint = "CreateWindowExW", SetLastError = false, StringMarshalling = StringMarshalling.Utf16)]
        ...
        /// <returns>如果该函数成功，则返回值为非零值。如果函数失败，则返回值为零。</returns>
        [LibraryImport(User32, EntryPoint = "DestroyWindow", SetLastError = false)]
        [return: MarshalAs(UnmanagedType.Bool)]
        ...
        [LibraryImport(User32, EntryPoint = "GetFocus", SetLastError = false)]
        ...
        /// 如果函数失败，则返回值为零。
        /// </returns>
        [LibraryImport(User32, EntryPoint = "RegisterClassW", SetLastError = false)]
